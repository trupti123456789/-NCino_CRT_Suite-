...
Data
 ...
 Adding Relationships
    ...
    ClickText           Next
    ${unique_name1}=    Generate Unique Name        ${Data["Name"]}
    TypeText            Relationship Name           ${unique_name1}
    Picklist            Type                        ${Data["Type"]}
    ...
    Run Keyword         Wait
    ClickText           Next
    ${unique_name2}=    Generate Unique Name        ${Data["Name1"]}
    TypeText            Relationship Name           ${unique_name2}
    Picklist            Type                        ${Data["Type1"]}
    ClickText           Save                        partial_match=False
    ...
    Run Keyword         Wait
    ClickText           Next
    ${unique_name3}=    Generate Unique Name        ${Data["Name2"]}
    TypeText            Relationship Name           ${unique_name3}
    Picklist            Type                        ${Data["Type2"]}
    ClickText           Save                        partial_match=False
    ...
    ClickCell           r1c1
    TypeText            Connected Relationship      ${unique_name1}
    Drop Down           Role                        ${Data["Role"]}
    ClickText           Save
    Run Keyword         Wait
    ...
    Use Table           Connected Relationship
    ClickCell           r1c1
    TypeText            Connected Relationship      ${unique_name2}
    Drop Down           Role                        ${Data["Role"]}
    ClickText           Save
